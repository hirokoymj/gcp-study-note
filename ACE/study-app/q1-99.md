...
- D is correct. A lot details mentioned in this group. Here I only say about eliminating answers. As we go down to between C and D. The question is want to review a inactive configure. So, to me, C is viewing info about all configure while D is apply a specific config and viewing it. So I eliminate C to go with D.

**kubectl config use-context**

- we’ve not yet addressed how to manage multiple kubectl configurations.[1]
...
3. View cluster config
kubectl config view
```

**Links:**

1. https://medium.com/google-cloud/kubernetes-engine-kubectl-config-b6270d2b656c
...
Answer: C (D will be correct.)

- C is incomplete. Moving projects under an organisation doesn't change their linked billing project.[1]

**Change the billing account for a project**

- Cloud Billing accounts can be used across organization resources. Moving a project from one organization resource to another won't impact billing, and charges will continue against the old billing account.[1]

- The given answers make D the only possible solution. C can not be right, you all need to look it up here:[2]

1. https://cloud.google.com/resource-manager/docs/project-migration#change_billing_account
2. https://cloud.google.com/resource-manager/docs/project-migration#permissions-billing
...
https://cloud.google.com/sdk/gcloud/reference/compute/instances/create#--address
...
- To run hello-app in your cluster, you need to deploy the application by running the following command:[3]
...
3. https://cloud.google.com/kubernetes-engine/docs/deploy-app-cluster
...
2. https://cloud.google.com/sdk/gcloud/reference/deployment-manager/deployments
...
1. https://www.techtarget.com/searchitoperations/tip/Compare-Kubernetes-StatefulSet-vs-deployment-vs-DaemonSet
...
- Selected Answer: A
  ...
  - It has to be A: one VPC, two subnets in different regions and different CIDR range. (It would also be valid to have both subnets in the same region.)
...
1. https://cloud.google.com/logging/docs/api/v2/resource-list
...
To create a resource in Deployment Manager, you must specify a type.[1]
...
1. https://cloud.google.com/deployment-manager/docs/fundamentals#types
2. https://cloud.google.com/deployment-manager/docs/configuration/type-providers/creating-type-provider
3. <hr />
...
**ClusterIp exposure < NodePort exposure < LoadBalancer exposure**[3]
