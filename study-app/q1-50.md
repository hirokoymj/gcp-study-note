...
```js
// Create dev configration
gcloud config configrations create dev
gcloud config set project example-dev-123
gcloud config set account test@example.com
gcloud config set compute/region us-central1
gcloud config set compute/zone us-central1-b

//Create prod configuration
gcloud config configuration create prod
gcloud config set project example-prod-123
gcloud config set account test@example.com
gcloud config set compute/region us-central1
gcloud config set compute/zone us-central1-b
...
gcloud config configuratinos activate prod
...
- BigQuery Data Viewer
  (roles/bigquery.dataViewer) - Read data and metadata from the table or view.
- Logs Viewer
...
- https://www.examtopics.com/discussions/google/view/16698-exam-associate-cloud-engineer-topic-1-question-26-discussion/
...
hiroko@cloudshell:~ (hiroko-test-361705)$
```
...
https://www.examtopics.com/discussions/google/view/16701-exam-associate-cloud-engineer-topic-1-question-27-discussion/
...
Beacause of this, I think you can't verify the addition of metadata labels through Activity Logs. https://cloud.google.com/logging/docs/audit#view-activity
```
...
- https://www.examtopics.com/discussions/google/view/18518-exam-associate-cloud-engineer-topic-1-question-29-discussion/
